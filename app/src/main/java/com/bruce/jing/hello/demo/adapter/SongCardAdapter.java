 ...
 * @date 2019/12/9
 */
public class SongCardAdapter extends BaseRecyclerAdapter<String> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(mContext).inflate(R.layout.item_song_card, parent, false);
...
//        Log.d(TAG, "onBindViewHolder squireLayoutWidth = " + squireLayoutWidth + " ,itemViewWidth = " + itemViewWidth);
    ...
    static class SongCardViewHolder extends RecyclerView.ViewHolder {
        ...
        public SongCardViewHolder(View itemView) {
            ...
            squireLayout = itemView.findViewById(R.id.sfl_song_card);
        }
    }
}

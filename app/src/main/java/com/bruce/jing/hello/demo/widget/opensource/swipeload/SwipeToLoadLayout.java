...
//    }
//
//    public int getLinearScrollY(RecyclerView recyclerView) {
//        int scrollY = 0;
//        LinearLayoutManager layoutManager = (LinearLayoutManager) recyclerView.getLayoutManager();
...
//    }
//
//    public int getLinearTotalHeight(RecyclerView recyclerView) {
//        int totalHeight = 0;
//        LinearLayoutManager layoutManager = (LinearLayoutManager) recyclerView.getLayoutManager();
...
//        if (scrollY + height < totalHeight - 50) {
//            isBottom = false;
//        }
//        return isBottom;
//    }
    ...
    public void setLoadMoreFooterView(View view) {
        if (view instanceof SwipeLoadMoreTrigger) {
            ...
            if (mFooterView != view) {
                ...
                ViewGroup.LayoutParams layoutParams = generateDefaultLayoutParams();
                layoutParams.height = getResources().getDimensionPixelOffset(R.dimen.dimen_margin_60);

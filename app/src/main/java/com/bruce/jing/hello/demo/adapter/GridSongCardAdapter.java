 ...
 * @date 2019/12/9
 */
public class GridSongCardAdapter extends BaseRecyclerAdapter<String> {

    private static final String TAG = "SongCardAdapter";

    public GridSongCardAdapter(Context context) {
        super(context);
    }

    @Override
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(mContext).inflate(R.layout.item_grid_song_card, parent, false);
